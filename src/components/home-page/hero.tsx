...
export default function Hero() {
  return (
    <section className="py-40 md:py-48 relative overflow-hidden">
      ...
      <div className="absolute top-1/4 left-1/4 w-96 h-96 bg-blue-500/20 rounded-full blur-3xl opacity-50"></div>
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-blue-400/20 rounded-full blur-3xl opacity-50"></div>
        ...
        <div className="max-w-4xl mx-auto text-center">
          ...
          <div className="space-y-6 text-lg">
            ...
            <div className="flex flex-wrap justify-center gap-4 pt-4">
              <div className="glass-card text-blue-500 px-6 py-3 rounded-full shadow-sm text-base">
